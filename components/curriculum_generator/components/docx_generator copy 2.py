...
class DocxGenerator:
    ...
    def generate_curriculum_docx(self, curriculum_data: Dict[str, Any], 
        ...
        try:
            ...
            self._add_curriculum_section_2(doc, curriculum_data, compact_mode)
            
            # Section 3: Delivery Options
            self._add_curriculum_section_3(doc, curriculum_data, compact_mode)
            
            # Section 4: Course Organization
            self._add_curriculum_section_4(doc, curriculum_data, compact_mode)
            
            # Section 5: Entry Requirements
            self._add_curriculum_section_5(doc, curriculum_data, compact_mode)
            
            # Section 6: Qualification & Recognition
            self._add_curriculum_section_6(doc, curriculum_data, compact_mode)
            
            # Section 7: Assessment Methods
            self._add_curriculum_section_7(doc, curriculum_data, compact_mode)
            
            # Section 8: Framework Alignment
            self._add_curriculum_section_8(doc, curriculum_data, compact_mode)
            
            # Section 9: Key Benefits
            self._add_curriculum_section_9(doc, curriculum_data, compact_mode)
            
            # Section 10: Cross-Border Compatibility
            self._add_curriculum_section_10(doc, curriculum_data, compact_mode)
    ...
    def generate_educational_profile_docx(self, profile_data: Dict[str, Any], 
        ...
        try:
            ...
            # Add sections
            self._add_profile_career_progression(doc, profile_data, compact_mode)
            self._add_profile_employers(doc, profile_data, compact_mode)
            self._add_profile_competencies(doc, profile_data, compact_mode)
            self._add_profile_program_structure(doc, profile_data, compact_mode)
            self._add_profile_assessment(doc, profile_data, compact_mode)
            self._add_profile_requirements(doc, profile_data, compact_mode)
            self._add_profile_cpd(doc, profile_data, compact_mode)
    ...
    def _add_profile_career_progression(self, doc: Document, profile_data: Dict[str, Any], compact_mode: bool = False):
    ...
    def _add_profile_employers(self, doc: Document, profile_data: Dict[str, Any], compact_mode: bool = False):
    ...
    def _add_profile_competencies(self, doc: Document, profile_data: Dict[str, Any], compact_mode: bool = False):
    ...
    def _add_profile_program_structure(self, doc: Document, profile_data: Dict[str, Any], compact_mode: bool = False):
    ...
    def _add_profile_assessment(self, doc: Document, profile_data: Dict[str, Any], compact_mode: bool = False):
    ...
    def _add_profile_requirements(self, doc: Document, profile_data: Dict[str, Any], compact_mode: bool = False):
    ...
    def _add_profile_cpd(self, doc: Document, profile_data: Dict[str, Any], compact_mode: bool = False):
